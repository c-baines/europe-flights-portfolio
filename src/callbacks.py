...
def register_callbacks(app): 
    ...
    def update_indicator_cards(month_string):
        ...
        fig.update_layout(
            height=200,
            margin=dict(t=30, b=10, l=10, r=10)  # reduce outer padding
        )
    ...
    def update_choropleth_year(year, month):
        ...
        choro_fig = go.Figure(go.Choropleth(
    ...
    def update_aircraft_graphs(year):
        ...
        fig = make_subplots(
            rows=1, cols=3,
            subplot_titles=('Manufacturer Share', 'Top Aircraft Models', 'Top Airlines'),
    ...
    def update_manufacturer_percent(year):
        """
        ...
        # want this plot to show manufacturer count by month and year 
        for manufacturer in df['manufacturer'].unique():
            df_subset = df[df['manufacturer'] == manufacturer]

            # want to show them as a share of the total 
